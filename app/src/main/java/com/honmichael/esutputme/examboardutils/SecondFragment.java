...
public class SecondFragment extends Fragment implements ExamNumberAdapter.OnClickAction,RadioButton.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    private void setUpQuestionView() {
        ...
        questions.setText(mQuestionEntry.getQuestion());
...
/*
    ...
    public ArrayList<QuestionEntry> getSecondFragmentResults(){
