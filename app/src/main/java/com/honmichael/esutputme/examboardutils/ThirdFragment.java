...
public class ThirdFragment extends Fragment implements ExamNumberAdapter.OnClickAction,RadioButton.OnClickListener, RadioGroup.OnCheckedChangeListener {
...
/*
    ...
    public ArrayList<QuestionEntry> getThirdFragmentResults(){
