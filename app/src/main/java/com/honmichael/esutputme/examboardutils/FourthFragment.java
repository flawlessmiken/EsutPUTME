...
public class FourthFragment extends Fragment implements ExamNumberAdapter.OnClickAction,RadioButton.OnClickListener, RadioGroup.OnCheckedChangeListener {
...
/*
    ...
    public ArrayList<QuestionEntry> getFourthFragmentResults(){
